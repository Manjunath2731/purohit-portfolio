...
//         <section
//             id="home"
//             className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-12 bg-gradient-to-br from-orange-100 via-yellow-50 to-red-100"
//         >
//             <span className="text-5xl mb-2 animate-pulse">🙏</span>
//             <h1 className="text-4xl md:text-6xl font-bold text-orange-800 leading-tight">
//                 Pandit Krishna Shastry
//             </h1>
//             <p className="text-lg md:text-xl text-gray-700 mt-4 max-w-xl">
//                 Experienced Hindu priest offering authentic Vedic rituals, pujas, and astrology consultations to bring peace and prosperity to your life.
//             </p>

//             <div className="mt-8 flex flex-col sm:flex-row gap-4">
//                 <button
//                     onClick={handleBookNow}
//                     className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-full text-lg flex items-center gap-2 shadow-lg transition"
//                 >
...
//                     className="border-2 border-orange-600 text-orange-700 hover:bg-orange-100 px-6 py-3 rounded-full text-lg flex items-center gap-2 transition"
//                 >
